...
def render_fore_forecast_fx():
 ...
 with st.spinner("Scaricamento dati da Yahoo Finance, elaborazione e calcolo modello..."):
 try:
 raw_data1 = yf.download(ticker1, period="10y", interval="1d", progress=False)['Close']
 raw_data2 = yf.download(ticker2, period="10y", interval="1d", progress=False)['Close']
 ...
 st.write(f"Critical Values (1%): {coint_test[2][0]:.4f}, (5%): {coint_test[2][1]:.4f}, (10%): {coint_test[2][2]:.4f}")
 with coint_col2:
